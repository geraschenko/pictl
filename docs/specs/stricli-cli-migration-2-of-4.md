# Stricli CLI migration, 2 of 4: typed command definitions

# SPEC

## Status

This document supersedes implementation-shape decisions from `docs/specs/stricli-cli-migration-1-of-4.md` where they conflict. The user-facing grammar and behavior from part 1 still apply.
